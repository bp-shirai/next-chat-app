...
import { AvatarIcon } from "@components/shared/form/AvatarIcon";
                        ...
                        <DropdownMenuContent className="w-full">
                          {unselectedFriends.map((friend) => (
                            <DropdownMenuCheckboxItem
                              key={friend._id}
                              className="flex items-center ga2 w-full p-2"
                            ...
                            >
                              <AvatarIcon imageUrl={friend.imageUrl} username={friend.username} />
